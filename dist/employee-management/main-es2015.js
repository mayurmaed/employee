...
const routes = [
    ...
    { path: 'addemployee', component: _add_employee_add_employee_component__WEBPACK_IMPORTED_MODULE_4__["AddEmployeeComponent"] },
];
...
let HttpClientService = class HttpClientService {
    ...
    deleteEmployee(employee) {
        return this.httpClient.delete('http://localhost:8081/employees' + '/' + employee.empId);
    }
    createEmployee(employee) {
        return this.httpClient.post('http://localhost:8081/employees', employee);
    }
};
...
module.exports = __webpack_require__(/*! E:\work\employee-management\src\main.ts */"./src/main.ts");
